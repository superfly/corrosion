...
docker run --rm -t \
    ...
    -e CORRO_METADATA_WRITE_VERSION="${CORRO_METADATA_WRITE_VERSION:-}" \
    -e CORRO_METADATA_USE_VERSION="${CORRO_METADATA_USE_VERSION:-}" \
    -e CORRO_SYNC_LOG_VERSION="${CORRO_SYNC_LOG_VERSION:-}" \
