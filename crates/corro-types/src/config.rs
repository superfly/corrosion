...
pub struct ConfigBuilder {
    ...
    crsqlite: Option<CrsqliteConfig>,
}
...
impl ConfigBuilder {
    ...
    /// Configure crsqlite metadata version settings (e.g. for V2 migration testing).
    pub fn crsqlite(mut self, config: CrsqliteConfig) -> Self {
        self.crsqlite = Some(config);
        self
    }
